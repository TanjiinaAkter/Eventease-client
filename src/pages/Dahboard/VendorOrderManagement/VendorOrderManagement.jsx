...
const VendorOrderManagement = () => {
  ...
  return (
    <div className="relative z-0 bg-black w-full h-full min-h-screen p-6">
      ...
      {/* Table Wrapper */}
      <div className="mx-auto mt-15 overflow-auto md:overflow-scroll border border-[#4b4d4c] w-full flex flex-col gap-4 p-2 pb-8 rounded-md bg-[#0f1c1c]">
        <div className="">
          <table className="table-auto w-full min-w-[600px] text-white text-center">
            ...
            <thead>
              <tr className="text-[#44cfbf] bg-black rounded-b-lg">
                ...
                <th className="px-1 py-3 text-lg md:text-base ">Income</th>
                <th className="px-1 py-3 text-lg md:text-base whitespace-nowrap">
                  Action
                </th>
              </tr>
            ...
            <tbody className="text-sm">
              {payments.map((payment) =>
                payment.eventDetails.map((eDetail) => {
                  // const currentNumberSerial = numberSerial;
                  // numberSerial += 1;
                  return (
                    <tr
                      key={eDetail._id}
                      ...
                      <td className=" py-2 whitespace-nowrap">
                        {(
                          (eDetail.price * eDetail.quantity * 10) /
                          100
                        ).toFixed(2)}
                      </td>
                      <td className=" py-2 whitespace-nowrap">
                        {(
                          eDetail.price * eDetail.quantity -
                          (eDetail.price * eDetail.quantity * 10) / 100
                        ).toFixed(2)}
                      </td>

                      <td className="pr-2 py-2 whitespace-nowrap flex justify-center items-center gap">
